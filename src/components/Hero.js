...
const Hero = () => {
  ...
  const handleDownloadResume = () => {
    ...
    link.download = 'Mahesh_Purohit_Resume.pdf';
      ...
      <div className="container-max text-center z-10 relative">
        ...
        >
          ...
          <motion.p
            ...
            className="text-primary-400 font-mono text-lg sm:text-xl"
          >
            Hello, I'm
          </motion.p>
          ...
          >
            <span className="gradient-text">Mahesh Purohith</span>
          </motion.h1>
          ...
          >
B-Tech Final Year • AI & Machine Learning Developer
          </motion.p>
          ...
          >
            <motion.button
              ...
              className="bg-gradient-to-r from-primary-500 to-primary-600 hover:from-primary-600 hover:to-primary-700 text-white px-8 py-4 rounded-lg font-semibold text-lg shadow-lg hover:shadow-xl transition-all duration-300 flex items-center gap-3"
            >
              <Download size={20} />
              Download Resume
            </motion.button>
